...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/zakarialabib/flysystem-google-drive-ext.svg?style=flat-square)](https://packagist.org/packages/zakarialabib/flysystem-google-drive-ext)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg?style=flat-square)](https://opensource.org/licenses/Apache-2.0)
[![Build Status](https://img.shields.io/travis/com/zakarialabib/flysystem-google-drive-ext/2.x.svg?style=flat-square)](https://travis-ci.com/zakarialabib/flysystem-google-drive-ext)
[![StyleCI](https://styleci.io/repos/113434522/shield?branch=2.x)](https://styleci.io/repos/113434522)
[![Total Downloads](https://img.shields.io/packagist/dt/zakarialabib/flysystem-google-drive-ext.svg?style=flat-square)](https://packagist.org/packages/zakarialabib/flysystem-google-drive-ext)
...
```bash
composer require zakarialabib/flysystem-google-drive-ext
```

- For **Flysystem V1** or **Laravel <= 8.x.x** use 1.x.x version of the package

```bash
composer require zakarialabib/flysystem-google-drive-ext:"^1.0.0"
```
